...
const solarSteps = [
  {
    ...
    description:
      'We model your roof\'s irradiance against your hourly consumption. The mismatch is your real BESS opportunity — usually larger than you expect.',
  },
  {
    number: '02',
