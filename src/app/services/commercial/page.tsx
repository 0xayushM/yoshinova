...
const commercialUseCases = [
  ...
  },
  {
    ...
    description:
      'Buffer fast-charger spikes so you don\'t blow your sanctioned load. Stack BESS + grid + solar to maximise charger utilisation.',
    metric: '+2x',
    ...
    <>
      ...
      <main className="relative min-h-screen bg-[#0a0a0a]">
          ...
          <MarketInsight
            ...
            keyDriver={{
              title: 'Open Access + ToD = the BESS unlock.',
              description:
            ...
            bullets={[
              'BEE\'s C&I energy benchmarking now penalises high peak demand factor (PDF) — BESS directly improves the score.',
              'Green Building (LEED v4.1, IGBC) credits for resilient, low-emission backup — replaces 100% of DG kWh.',
              'Net-metering caps cleared in most states, letting BESS+solar export at peak with full tariff credit.',
            ]}
          />
