  ...
  return (
    <>
      ...
      <div className="pt-24 md:pt-28 lg:pt-32 pb-16 md:pb-20 px-4 sm:px-6 md:px-8 lg:px-10 xl:px-14 max-w-[1600px] mx-auto">
        <h1 className="text-center text-gray-600 text-xl md:text-2xl lg:text-3xl font-bold uppercase tracking-tight mb-8 md:mb-12">
          All Services
        </h1>
          ...
          {services.map((service) => (
            ...
            >
              ...
              <div className="absolute inset-0 pb-6 md:pb-8 lg:pb-10 flex flex-col items-center justify-end z-10">
                <h2 className="text-white text-xl sm:text-2xl md:text-3xl lg:text-3xl xl:text-4xl font-bold uppercase tracking-tight text-center px-3 drop-shadow-lg">
                  {service.label}
                </h2>
              </div>
            </Link>
