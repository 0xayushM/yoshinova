...
const industrialUseCases = [
  ...
  },
  {
    ...
    title: 'Food & Beverage',
    description:
      'Cold storage, packaging and CIP cycles can\'t tolerate outages. BESS rides through brownouts and protects spoilage risk.',
    metric: '24/7',
  ...
  },
  {
    ...
    description:
      'Tier-1 and Tier-2 suppliers facing OEM uptime SLAs. Pair BESS with rooftop solar to lower your green-supply ratio.',
    metric: '6 yr',
    ...
    <>
      ...
      <main className="relative min-h-screen bg-[#0a0a0a]">
          ...
          <MarketInsight
            ...
            bullets={[
              'Captive solar penetration grew 2.4× in MSME industrial belts (2022–25). BESS unlocks the unused evening/night fraction.',
              'BIS-IS 16270 / IEC 62619 certifications now mandatory — Yoshinova is compliant out of the box.',
              'PLI and MNRE incentives apply to integrated BESS+RE projects above 500 kWh capacity.',
            ]}
          />
          ...
          <UseCaseGrid
            ...
            description="Every floor is different. We've shipped industrial-grade BESS across heavy and light manufacturing — here's where the ROI lands fastest."
