    ...
    <>
      ...
      <main className="relative min-h-screen bg-[#0a0a0a]">
              ...
              <div>
                <div className="flex items-center justify-between mb-6 md:mb-8">
                  ...
                  <p className="text-black/40 text-xs uppercase tracking-widest hidden md:block">
                    Diesel out — BESS in — 24/7 signal
                  </p>
                </div>
          ...
          <MarketInsight
            ...
            bullets={[
              'TRAI consultation papers (Mar 2025) explicitly call out lithium-ion BESS as the preferred replacement for VRLA + DG hybrids.',
