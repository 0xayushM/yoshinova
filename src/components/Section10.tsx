  ...
  return (
    ...
    <section className="w-screen h-[100vh] relative flex items-center justify-center">
      ...
      <div className="relative z-10 px-8 md:px-16 py-12 md:py-16 max-w-4xl text-center bg-black/40 backdrop-blur-sm border border-white/10">
        ...
        <div className="mb-6">
          <h2 className="text-white text-3xl md:text-6xl lg:text-7xl font-medium uppercase tracking-tight leading-[1]">
            We audit first.
          </h2>
          <h2 className="text-[#8BC34A] text-3xl md:text-6xl lg:text-7xl font-medium uppercase tracking-tight leading-[1]">
            Then we deploy.
          </h2>
        </div>
