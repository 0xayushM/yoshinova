  ...
  return (
    ...
    <section className="w-screen h-screen md:min-h-screen relative overflow-hidden bg-slate-300/90">
      <div className="w-full h-full flex flex-col justify-end md:justify-center items-end">
        {/* Title Section */}
      <div className="w-full py-8 md:py-12 lg:py-16 px-4 sm:px-6 md:px-8 lg:px-12 md:pt-32 lg:pt-48 flex flex-col">
        <p className="text-black/40 text-xs uppercase tracking-widest mb-3 leading-[0.9]">The Problem We Solve</p>
        <h1 className="text-black uppercase text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light text-left leading-[1] tracking-tighter">
          The dual bleed
        </h1>
        <h1 className="text-black uppercase text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-normal text-left leading-[1] tracking-tighter">
          in power costs
        </h1>
      </div>

      {/* Grid Layout - 4 columns */}
      <div className="w-full h-[calc(100%-250px)] grid md:grid-cols-2 xl:grid-cols-4">
        {/* Column 1: Image */}
        <div className="hidden xl:block bg-slate-400 relative overflow-hidden">
          <Image
        ...
        <div className="bg-slate-200 flex flex-col justify-center p-4 md:p-6 lg:p-8 xl:p-12">
          <div>
            <h2 className="text-black text-xl md:text-2xl lg:text-3xl font-normal mb-0 md:mb-4 lg:mb-6">
              Inside Bleed
            </h2>
        ...
        <div className="bg-slate-100 flex flex-col justify-center p-4 md:p-6 lg:p-8 xl:p-12">
          <div>
            <h2 className="text-black text-xl md:text-2xl lg:text-3xl font-normal mb-4 md:mb-4 lg:mb-6">
              Outside Bleed
            </h2>
            <p className="text-black text-xs md:text-sm lg:text-base leading-relaxed mb-2 md:mb-4 lg:mb-8">
        ...
        <div className="bg-[#6A9F30] flex flex-col justify-center p-4 md:p-6 lg:p-8 xl:p-12 md:col-span-2 xl:col-span-1">
          <div>
            <h2 className="text-white text-xl md:text-2xl lg:text-3xl font-normal mb-4 md:mb-4 lg:mb-6">
              Our Approach
            </h2>
