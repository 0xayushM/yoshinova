  ...
  return (
    ...
    >
      ...
      <g>
        ...
        <text x="60" y="412" fontSize="10" fill="#94a3b8" fontFamily="monospace">RANK SAVINGS BY ROI — QUICK FIXES FIRST, BESS LAST</text>
      </g>
      ...
      <g transform="translate(60, 440)">
        ...
        {(() => {
          const bars = [
            ...
            { label: 'BESS deployment', val: 14, h: 105, color: '#4f7a1f' },
