...
export default function ResidentialFlow() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Story: BESS surges → appliances light up one by one
      ...
      // BESS surge — power line pulses from BESS to home
      tl.to('.res-bess-flow', {
        strokeDashoffset: -80,
        duration: 0.9,
        ease: 'power2.out',
  ...
  return (
    ...
    >
      ...
      {/* BESS → Home — primary power delivery line, animated by master timeline */}
      <path
