 ...
 * GRID (peak hours) → BESS → Factory floor (stable supply)
 *
    ...
    <div className="w-full">
      ...
      >
        ...
        <g transform="translate(380, 110)">
          ...
          <text x="70" y="-10" textAnchor="middle" fontSize="11" fill="#4f7a1f" fontFamily="monospace" letterSpacing="2" fontWeight="bold">NOVAMAX BESS</text>
