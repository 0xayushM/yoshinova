...
const PILLARS = [
  ...
  },
  {
    ...
    description: 'BESS sized on your real load curve. ROI guaranteed, not estimated.',
    metric: '100%',
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 min-h-screen xl:min-h-0">
          ...
          <div className="xl:col-span-6 px-6 sm:px-10 md:px-14 lg:px-20 pt-24 md:pt-28 pb-10 md:pb-20 flex flex-col justify-between bg-white relative">
            ...
            <div className="mt-8 md:mt-12 max-w-xl">
              ...
              <h2 className="text-black text-xl sm:text-2xl md:text-3xl lg:text-4xl font-normal leading-snug mb-6">
              ...
              <div className="flex flex-wrap items-center gap-3 md:gap-4">
                <button
                  ...
                  className="group inline-flex items-center gap-3 px-5 py-3 md:px-6 md:py-4 bg-[#6A9F30] text-white text-xs md:text-sm font-semibold uppercase tracking-widest hover:bg-[#5a8f20] transition-all duration-300 cursor-pointer"
                >
                  Talk to our advisor
                  <svg
                ...
                <a
                  href="/about"
                  className="inline-flex items-center gap-2 px-5 py-3 md:px-6 md:py-4 border border-black/20 text-black text-xs md:text-sm uppercase tracking-widest hover:border-black hover:bg-black hover:text-white transition-all duration-300"
                >
                  About Yoshinova
                </a>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 md:gap-6 mt-8 md:mt-12 pt-6 md:pt-8 border-t border-black/10">
                <div>
                  <p className="text-2xl md:text-3xl font-medium text-black">IMS</p>
                  <p className="text-[10px] md:text-xs text-black/50 uppercase tracking-wider mt-1">Certified</p>
                </div>
                <div>
                  <p className="text-2xl md:text-3xl font-medium text-black">R&D</p>
                  <p className="text-[10px] md:text-xs text-black/50 uppercase tracking-wider mt-1">Govt. Recognised</p>
                </div>
                <div>
                  <p className="text-2xl md:text-3xl font-medium text-black">LFP</p>
          ...
          <div className="hidden xl:block xl:col-span-6 relative overflow-hidden bg-slate-200">
            ...
            <div className="absolute bottom-8 left-8 right-8 text-white">
              ...
              <p className="text-lg font-semibold leading-tight">
                Lithium-ion BESS engineered<br />and assembled in-house
              </p>
            </div>
          </div>
        </div>
          ...
          {PILLARS.map((p, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className={`${titleColor} text-2xl md:text-3xl lg:text-4xl font-light leading-tight mb-3`}>
                  {p.title}
                </h3>
