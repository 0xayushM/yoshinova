...
export const P3 = new THREE.Vector3(1, 0.6, 0.75); // residential
export const P4 = new THREE.Vector3(0, 0.4, 4.2); // society
export const P5 = new THREE.Vector3(1, -0.2, 4.8); // telecom
export const P6 = new THREE.Vector3(1.3, 0.5, 3.05); // industrial
...
export const getPositions = (isMobile: boolean) => {
  if (isMobile) {
    return {
      posAList: [P0_MOBILE, P0_MOBILE, P1_MOBILE, P2_MOBILE, P3_MOBILE, P4_MOBILE, P5_MOBILE, P6_MOBILE, P7_MOBILE, P8_MOBILE, P9_MOBILE, P1_MOBILE, P1_MOBILE],
      posBList: [P0_MOBILE, P1_MOBILE, P2_MOBILE, P3_MOBILE, P4_MOBILE, P5_MOBILE, P6_MOBILE, P7_MOBILE, P8_MOBILE, P9_MOBILE, P1_MOBILE, P1_MOBILE, P1_MOBILE],
      rotAList: rotAList,
      rotBList: rotBList
    };
  }
  return {
    posAList: [P0, P1, P1, P2, P2, P3, P4, P5, P6, P7, P8, P2, P10],
    posBList: [P1, P1, P2, P2, P3, P4, P5, P6, P7, P8, P2, P10, P2],
    rotAList: rotAList,
    rotBList: rotBList
  };
};
...
export const rotAList = [Q_thirdSection, Q_secondSection,Q_secondSection, Q_thirdSection, Q_thirdSection, Q_fourthSection, Q_section5, Q_section6, Q_section7, Q_section8, Q_section9, Q_thirdSection, Q_secondSection, Q_thirdSection];
export const rotBList = [Q_secondSection,Q_secondSection, Q_thirdSection, Q_thirdSection, Q_fourthSection, Q_section5, Q_section6, Q_section7, Q_section8, Q_section9, Q_thirdSection, Q_secondSection, Q_thirdSection];
